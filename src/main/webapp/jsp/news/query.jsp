...
<div class="layui-layout layui-layout-admin" id="isHide">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px 30px;">
            <div style="margin-left: 30px;margin-top: 20px;"><h3>新闻管理：搜索结果</h3></div>
            <div class="header">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="9">
                                ...
                                <p class="page">
                                    <a href="${path}/news/fuzzyQuery?pageNo=${pageInfo.firstPage}&text=${info}">第一页</a>
                                    <c:if test="${pageInfo.hasPreviousPage}">
                                        <a href="${path}/news/fuzzyQuery?pageNo=${pageInfo.pageNum-1}&text=${info}">上一页</a>
                                    </c:if>
                                    <c:if test="${pageInfo.hasNextPage}">
                                        <a href="${path}/news/fuzzyQuery?pageNo=${pageInfo.pageNum+1}&text=${info}">下一页</a>
                                    </c:if>
                                    <a href="${path}/news/fuzzyQuery?pageNo=${pageInfo.lastPage}&text=${info}">最后页</a>
                                    ...
                                    <script>
                                        $("#page").blur(function(){
                                            if($(this).val() == ""){
                                                $("#jump").attr("href","${path}/news/fuzzyQuery?pageNo="+1+"&text=${info}");
                                            }else{
                                                $("#jump").attr("href","${path}/news/fuzzyQuery?pageNo="+$(this).val()+"&text=${info}");
                                            }
                                        })
                                    </script>
                                </p>
