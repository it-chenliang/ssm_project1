...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px 30px;">
            <div style="margin-left: 30px;margin-top: 20px;"><h3>新闻类别：修改类别</h3></div>
            <div class="add-content">
                <div class="header-left">
                    <a href="${path}/type/all" class="btn btn-primary">类别列表</a>
                </div>
                <div class="add-content-input">
                    <form action="${path}/type/update" method="post">
                        <input type="hidden" name="id" id="typeId" class="form-control" value="${type.id}">
                        <input type="text" value="${type.name}" name="name" id="typeName" class="form-control"><br>
                        <h3>${msg}</h3>
                        <div class="submit">
