    ...
    <div class="body">
        <div class="userInfo-menu">
            <div class="userInfo-menu-header">
                <div class="userInfo-menu-header-img" id="header-img">
                    <script>
                        if("${sessionScope.user.headPortrait}"==""){
                            $("#header-img").html('<img src="/uploads/1561103430163.jpg" alt="">');
                        }else{
                            $("#header-img").html('<img src="${sessionScope.user.headPortrait}" alt="">');
                        }
                    </script>
                </div>
            ...
            <ul class="userInfo-bar">
                <li class="active"><a href="javascript:;"><i class="glyphicon glyphicon-user"></i>基本资料</a></li>
                <li><a href="javascript:;"><i class="glyphicon glyphicon-comment"></i>评论管理</a></li>
                <li><a href="javascript:;"><i class="glyphicon glyphicon-lock"></i>安全中心</a></li>
            </ul>
        </div>
        <div class="userInfo-content" id="userInfo-content">
            <div class="user-form" style="display: block;">
                ...
                <div class="userInfo-content-detail">
                    <p>上次登录:<fmt:formatDate value="${sessionScope.user2.lastLoginTime}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></p>
...
<script>
    ...
    $(function(){
        $.ajax({
            ...
            success:function (data) {
                if(data.length==0){
                    $("#all-comment").append('<h3>您还未进行任何评论</h3>');
                }else{
                    for(var i=0;i<data.length;i++){
